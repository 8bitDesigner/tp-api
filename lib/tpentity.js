...
TPEntity.prototype.comment = function(cb) {
 ...
 */
TPEntity.prototype.then = function(cb, opts) {
  opts.json = _.extend({}, opts.json, {Id: this.Id}) // mixing in id so TP will be able to get the right object
